// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, avoid_unnecessary_containers, sized_box_for_whitespace, use_key_in_widget_constructors, prefer_interpolation_to_compose_strings, unused_import, unused_local_variable, prefer_const_declarations, unnecessary_string_interpolations, unnecessary_cast, unnecessary_null_comparison, prefer_if_null_operators, empty_catches
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    super.initState();
    allProducts = apiWorks.fetchProducts();
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          return ListView.builder(
                            ...
                            physics: NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) {
                              Product product = allProductsList[index];
                              return Column(
                                children: [
                                  Container(
                                    height: 200,
